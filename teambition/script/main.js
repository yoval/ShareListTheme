...
console.log("\n %c 网盘挂载程序" + " v2.0 " + "https://media.cooluc.com/source/sharelist ", "color:#fff;background:linear-gradient(90deg,#448bff,#44e9ff);padding:5px 0;")
console.log("\n %c Cooluc\'s Blog | Copyright © " + new Date().getFullYear() + " 本站保留所有权利 ", "color:#fff;background:linear-gradient(90deg,#448bff,#44e9ff);padding:5px 0;")